      ...
      <div className="container lg:pt-5">
        <div className="text-center">
          ...
          <p className="lg:max-w-[600px] lg:mx-auto text-headingColor font-[500] text-[16px] leading-7">
            ...
            and apply them to real-world projects. Seeking an opportunity to
            contribute to a team building innovative and
                    ...
                    <div className="w-full sm:w-1/2 sm:pr-8">
                      ...
                      >
                        ...
                        <p className="text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7">
                          Experience with HTML, CSS, and JavaScript. Also, I
                          have knowledge of Figma and Adobe XD. Proven ability
                          to learn new technologies quickly and apply them to
                          real-world projects.
                        </p>
                      </div>
                    </div>
